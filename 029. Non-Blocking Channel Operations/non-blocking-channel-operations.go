/*
	Basuc sends and receives on channels are blocking. However, we can use select with a default clause tomimplement non-blocking sends, receives, and even non-blocking multiway selects
*/
